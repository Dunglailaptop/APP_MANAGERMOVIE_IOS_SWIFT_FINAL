...
class ManagementBillProductViewController: BaseViewController {

    var viewModel = ManagementBillProductViewModel()
    var router = ManagementBillProductRouter()
...
extension ManagementBillProductViewController {
    func getListALLbill() {
...
extension ManagementBillProductViewController: UITableViewDelegate {
