...
class ManageBillAccountRouter {
    ...
    private func createViewController()-> UIViewController {
        let view = ManageBillAccountViewController(nibName: "ManageBillAccountViewController", bundle: Bundle.main)
        return view
    }
