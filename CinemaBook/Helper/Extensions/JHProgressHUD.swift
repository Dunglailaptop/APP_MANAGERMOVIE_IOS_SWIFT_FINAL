...
//
   ...
   static let sharedHUD : JHProgressHUD =  { JHProgressHUD()}()
    ...
    func showInView(_ view : UIView, withHeader title : String?, andFooter footer : String?)
    {
        ...
        activityIndicator.color = ColorUtils.blue_color()//UIColor(red: 211.0/255.0, green: 211.0/255.0, blue: 211.0/255.0, alpha: 1.0)
        ...
        loading.tintColor = ColorUtils.blue_color()
